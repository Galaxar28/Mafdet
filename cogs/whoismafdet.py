...
class WhoisMafdet(commands.Cog):
    ...
    @commands.command()
    async def whoismafdet(self, ctx):
        """Learn about me"""
        # build a nice embed for this
        ...
        description="Known as \"Slayer of Serpents\" and \"The Great Cat\", Mafdet dates from the First Dynasty of ancient Egypt.  She is the defender against venemous creatures like snakes and scorpions and is the protector of the pharaoh."
